...
const BagDrawerContent = () => {
  ...
  // ⚡ Bolt Performance Optimization: Wrap the subtotal .reduce() calculation in useMemo
  // to prevent O(N) execution overhead during React render cycles (e.g. checkingOut state changes).
