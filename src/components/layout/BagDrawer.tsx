...
export const BagDrawer = () => {
  ...
  // ⚡ Bolt Performance Optimization: Memoize the O(N) array reduction
  // out of the main render loop into useMemo to prevent recalculating metric sums on every render.
